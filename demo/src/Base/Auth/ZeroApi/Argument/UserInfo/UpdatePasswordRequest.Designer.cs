...
namespace Agebull.Common.Organizations
{
    ...
    public partial class UpdatePasswordRequest  : MicroZero.ZeroApis.IApiArgument
    {
        ...
        {
            return $@"UserPassword={HttpUtility.UrlEncode(UserPassword, Encoding.UTF8)}";
        }
        ...
        public ValidateResult Validate()
        {
            ...
            if(string.IsNullOrWhiteSpace(UserPassword))
                 result.AddNoEmpty("新密码",nameof(UserPassword));
            ValidateEx(result);
            return result;
        }
        #endregion

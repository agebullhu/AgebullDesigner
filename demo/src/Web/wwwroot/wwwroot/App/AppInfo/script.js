/*此标记表明此文件可被设计器更新,如果不允许此操作,请删除此行代码.design by:agebull designer date:2019/4/20 9:30:45*/
/*
...
var page = {
    ...
    */
    setFormValidate: function() {
        ...
        $('#Host').textbox({validType:['strLimit[0,200]']});
    ...
    */
    ...
    [
       [
            ...
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'host', title: '基地址'}

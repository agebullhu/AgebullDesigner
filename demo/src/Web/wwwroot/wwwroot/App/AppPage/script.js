/*此标记表明此文件可被设计器更新,如果不允许此操作,请删除此行代码.design by:agebull designer date:2019/4/20 10:32:42*/
/*
*   站点页面关联的前端操作类对象,实现基本的增删改查的界面操作
*/
var page = {
    /**
    表格对象
    ...
    */
    setFormValidate: function() {
        $('#SitePageId').textbox({validType:['noZero[0]']});

    },

    /**
     * 生成站点页面关联的编辑器
     * @param {SitePagePage} me 当前页面对象
    ...
    */
    ...
    [
       [
            ...
            //, { styler: vlStyle, halign: 'center', align: 'center', sortable: true, field: 'sitePageId', title: 'ID'}

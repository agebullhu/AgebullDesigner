/*此标记表明此文件可被设计器更新,如果不允许此操作,请删除此行代码.design by:agebull designer date:2019/4/15 11:44:13*/
/*
*   角色的前端操作类对象,实现基本的增删改查的界面操作
*/
var page = {
    /**
    表格对象
    ...
    */
    setFormValidate: function() {
        $('#Role').textbox({required:true,validType:['strLimit[0,200]']});
        $('#Caption').textbox({required:true,validType:['strLimit[0,200]']});

    },

    /**
     * 生成角色的编辑器
     * @param {RolePage} me 当前页面对象
    ...
    */
    ...
    [
       [
            ...
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'OrgID', title: '组织标识'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'SiteID', title: '站点标识'}
        ]
    ]
};

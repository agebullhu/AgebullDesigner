    ...
    */
    ...
    [
       [
            ...
            //, { styler: vlStyle, halign: 'center', align: 'center', sortable: true, field: 'RoleOrgId', title: 'ID'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'SiteID', title: '站点编号'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'RoleID', title: '角色编号'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'OrgID', title: '组织编号'}
        ]
    ]
};

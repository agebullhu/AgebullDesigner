...
var page = {
    ...
    */
    setFormValidate: function() {
        $('#OpenId').textbox({validType:['strLimit[0,16]']});
        $('#Os').textbox({validType:['strLimit[0,200]']});
        $('#App').textbox({validType:['strLimit[0,200]']});
        $('#DeviceId').textbox({validType:['strLimit[0,100]']});
        $('#Channel').textbox({validType:['strLimit[0,200]']});
        $('#TraceMark').textbox({validType:['strLimit[0,200]']});

    },

    /**
     * 生成用户信息的编辑器
     * @param {UserPage} me 当前页面对象
    ...
    */
    ...
    [
       [
            ...
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'UserType', title: '用户类型', formatter: userTypeFormat , width:1}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'OpenId', title: '用户代码' , width:1}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'Status', title: '用户状态', formatter: userStatusTypeFormat , width:1}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'AuthorizeScreen', title: '已认证场景', formatter: authorizeTypeFormat , width:1}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'RegistSoure', title: '注册来源', formatter: authorizeTypeFormat , width:1}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'Os', title: '注册来源操作系统' , width:3}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'App', title: '注册时的应用' , width:1}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'DeviceId', title: '注册时设备识别码' , width:2}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'Channel', title: '注册来源渠道码' , width:3}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'TraceMark', title: '注册来源活动跟踪码' , width:3}
        ]
    ]
};

...
var page = {
    ...
    */
    setFormValidate: function() {
        ...
        $('#IdCard').textbox({validType:['strLimit[0,100]']});
        $('#RealName').textbox({validType:['strLimit[0,200]']});
        $('#AvatarUrl').textbox({validType:['strLimit[0,200]']});
        $('#PhoneNumber').textbox({validType:['strLimit[0,20]']});
        $('#Nation').textbox({validType:['strLimit[0,200]']});
        $('#Tel').textbox({validType:['strLimit[0,200]']});
        $('#Email').textbox({validType:['strLimit[0,200]']});
        $('#HomeAddress').textbox({validType:['strLimit[0,200]']});

    },

    /**
     * 生成个人信息的编辑器
     * @param {PersonPage} me 当前页面对象
    ...
    */
    ...
    [
       [
            ...
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'certType', title: '证件类型', formatter: cardTypeFormat}
            ...
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'birthday', title: '生日', formatter: dateFormat}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'nation', title: '民族'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'tel', title: '电话'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'email', title: '电子邮件'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'homeAddress', title: '地址'}
        ]
    ]
};

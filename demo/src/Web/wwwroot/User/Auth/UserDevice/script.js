...
var page = {
    ...
    */
    ...
    /**
     * 生成用户设备信息的编辑器
     * @param {UserDevicePage} me 当前页面对象
    ...
    */
    ...
    [
       [
            ...
            , { styler: vlStyle,width:3, halign: 'center', align: 'left', sortable: true, field: 'Os', title: '设备操作系统'}
            , { styler: vlStyle,width:3, halign: 'center', align: 'left', sortable: true, field: 'App', title: '登录应用'}
            , { styler: vlStyle,width:3, halign: 'center', align: 'left', sortable: true, field: 'DeviceInfo', title: '详细信息'}

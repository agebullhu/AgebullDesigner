/*此标记表明此文件可被设计器更新,如果不允许此操作,请删除此行代码.design by:agebull designer date:2019/3/3 0:16:23*/
/*
...
var page = {
     ...
     * API前缀
     */
    apiPrefix: 'Auth/GovernmentArea/v1/',
    /**
     * 列表的URL
     */
    listUrl: 'edit/list',
    ...
    */
    setFormValidate: function() {
        $('#Code').textbox({validType:['strLimit[0,16]']});
        $('#FullName').textbox({validType:['strLimit[0,100]']});
        $('#ShortName').textbox({validType:['strLimit[0,20]']});
        $('#TreeName').textbox({validType:['strLimit[0,500]']});

    },

    /**
     * 生成行政区域的编辑器
     * @param {GovernmentAreaPage} me 当前页面对象

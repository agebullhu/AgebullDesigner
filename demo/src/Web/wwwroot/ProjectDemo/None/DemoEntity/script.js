/*此标记表明此文件可被设计器更新,如果不允许此操作,请删除此行代码.design by:agebull designer date:2019/3/5 14:08:53*/
/*
*   演示实体的前端操作类对象,实现基本的增删改查的界面操作
*/
var page = {
    /**
    表格对象
    ...
    */
    setFormValidate: function() {
        $('#Name').textbox({validType:['strLimit[0,200]']});
        $('#Memo').textbox({validType:['strLimit[0,200]']});

    },

    /**
     * 生成演示实体的编辑器
     * @param {DemoEntityPage} me 当前页面对象
    ...
    */
    ...
    [
       [
            ...
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'name', title: '名称'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'price', title: '价格'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'value', title: '数量'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'memo', title: '注释'}
        ]
    ]
};
...
mainPageOptions.extend({
    doPageInitialize: function (callback) {
        globalOptions.api.customHost = globalOptions.api.projectDemoHost;

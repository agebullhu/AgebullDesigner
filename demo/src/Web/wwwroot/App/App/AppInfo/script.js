...
var page = {
    ...
    */
    onFormUiLoaded: function (editor,callback) {
        ...
        me.setFormValidate();
        //组织标识下拉列表
        comboRemote('#orgId', 'Auth/org/v1/edit/combo');
        if (callback)
            callback();
    },
    /**
    ...
    */
    ...
    [
       [
            ...
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'organization', title: '机构' , width:3}
            ...
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'classify', title: '应用类型', formatter: classifyTypeFormat , width:1}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'appId', title: '应用标识' , width:3}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'managOrgcode', title: '注册管理机构代码'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'managOrgname', title: '注册管理机构名称'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'cityCode', title: '所在市级编码'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'districtCode', title: '所在区县编码'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'orgAddress', title: '机构详细地址'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'lawPersonname', title: '机构负责人'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'lawPersontel', title: '机构负责人电话'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'contactName', title: '机构联系人'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'contactTel', title: '机构联系人电话'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'superOrgcode', title: '上级机构代码'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'updateDate', title: '更新时间', formatter: dateFormat}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'updateUserid', title: '更新操作员工号'}
            , { styler: vlStyle,halign: 'center', align: 'left', sortable: true, field: 'updateUsername', title: '更新操作员姓名'}
        ]
    ]
};

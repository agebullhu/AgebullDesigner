...
namespace HPC.Projects.DataAccess
{
    ...
    /// 组织和员工
    /// </summary>
    sealed partial class OrganizationAndEmployeeDataAccess : SqlServerTable<OrganizationAndEmployeeData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<OrganizationAndEmployeeData, bool>> lambda)
        {

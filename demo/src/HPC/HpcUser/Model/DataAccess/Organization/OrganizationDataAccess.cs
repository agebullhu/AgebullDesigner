...
namespace HPC.Projects.DataAccess
{
    ...
    /// 组织机构
    /// </summary>
    sealed partial class OrganizationDataAccess : SqlServerTable<OrganizationData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<OrganizationData, bool>> lambda)
        {

...
namespace HPC.Projects.DataAccess
{
    ...
    /// 组织类型
    /// </summary>
    sealed partial class OrganizationTypeDataAccess : SqlServerTable<OrganizationTypeData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<OrganizationTypeData, bool>> lambda)
        {

...
namespace HPC.Projects.DataAccess
{
    ...
    /// 组织中的组织
    /// </summary>
    sealed partial class OrganizationInOrgDataAccess : SqlServerTable<OrganizationInOrgData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<OrganizationInOrgData, bool>> lambda)
        {

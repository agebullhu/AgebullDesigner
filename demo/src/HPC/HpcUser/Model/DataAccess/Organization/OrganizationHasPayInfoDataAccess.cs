...
namespace HPC.Projects.DataAccess
{
    ...
    /// 组织是否支付信息
    /// </summary>
    sealed partial class OrganizationHasPayInfoDataAccess : SqlServerTable<OrganizationHasPayInfoData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<OrganizationHasPayInfoData, bool>> lambda)
        {

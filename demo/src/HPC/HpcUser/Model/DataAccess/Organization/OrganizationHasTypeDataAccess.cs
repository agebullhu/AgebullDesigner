...
namespace HPC.Projects.DataAccess
{
    ...
    /// 组织有类型
    /// </summary>
    sealed partial class OrganizationHasTypeDataAccess : SqlServerTable<OrganizationHasTypeData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<OrganizationHasTypeData, bool>> lambda)
        {

...
namespace HPC.Projects.DataAccess
{
    ...
    /// 导航表
    /// </summary>
    sealed partial class PermitNavigationAllDataAccess : SqlServerTable<PermitNavigationAllData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<PermitNavigationAllData, bool>> lambda)
        {

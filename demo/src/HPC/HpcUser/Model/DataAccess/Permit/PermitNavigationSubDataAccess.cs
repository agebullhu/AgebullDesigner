...
namespace HPC.Projects.DataAccess
{
    ...
    /// 导航关联
    /// </summary>
    sealed partial class PermitNavigationSubDataAccess : SqlServerTable<PermitNavigationSubData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<PermitNavigationSubData, bool>> lambda)
        {

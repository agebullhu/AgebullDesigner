...
namespace HPC.Projects.DataAccess
{
    ...
    /// 许可权
    /// </summary>
    sealed partial class PermitRightDataAccess : SqlServerTable<PermitRightData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<PermitRightData, bool>> lambda)
        {

...
namespace HPC.Projects.DataAccess
{
    ...
    /// 角色导航关联
    /// </summary>
    sealed partial class PermitRoleAndNavigationDataAccess : SqlServerTable<PermitRoleAndNavigationData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<PermitRoleAndNavigationData, bool>> lambda)
        {

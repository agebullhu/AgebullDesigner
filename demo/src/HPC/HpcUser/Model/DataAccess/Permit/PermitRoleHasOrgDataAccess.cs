...
namespace HPC.Projects.DataAccess
{
    ...
    /// 角色组织关联
    /// </summary>
    sealed partial class PermitRoleHasOrgDataAccess : SqlServerTable<PermitRoleHasOrgData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<PermitRoleHasOrgData, bool>> lambda)
        {

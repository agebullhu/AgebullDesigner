...
namespace HPC.Projects.DataAccess
{
    ...
    /// 角色
    /// </summary>
    sealed partial class PermitRoleDataAccess : SqlServerTable<PermitRoleData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<PermitRoleData, bool>> lambda)
        {

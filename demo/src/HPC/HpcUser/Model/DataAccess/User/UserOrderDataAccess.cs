...
namespace HPC.Projects.DataAccess
{
    ...
    /// 用户端
    /// </summary>
    sealed partial class UserOrderDataAccess : SqlServerTable<UserOrderData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<UserOrderData, bool>> lambda)
        {

...
namespace HPC.Projects.DataAccess
{
    ...
    /// 用户订单列表
    /// </summary>
    sealed partial class UserOrderListDataAccess : SqlServerTable<UserOrderListData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<UserOrderListData, bool>> lambda)
        {

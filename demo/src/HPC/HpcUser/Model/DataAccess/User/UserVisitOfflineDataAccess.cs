...
namespace HPC.Projects.DataAccess
{
    ...
    /// 用户离线访问
    /// </summary>
    sealed partial class UserVisitOfflineDataAccess : SqlServerTable<UserVisitOfflineData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<UserVisitOfflineData, bool>> lambda)
        {

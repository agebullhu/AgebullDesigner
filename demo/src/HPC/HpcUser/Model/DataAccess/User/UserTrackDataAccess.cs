...
namespace HPC.Projects.DataAccess
{
    ...
    /// 用户跟踪
    /// </summary>
    sealed partial class UserTrackDataAccess : SqlServerTable<UserTrackData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<UserTrackData, bool>> lambda)
        {

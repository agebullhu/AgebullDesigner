...
namespace HPC.Projects.DataAccess
{
    ...
    /// 用户行为
    /// </summary>
    sealed partial class UserBehaviorDataAccess : SqlServerTable<UserBehaviorData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<UserBehaviorData, bool>> lambda)
        {

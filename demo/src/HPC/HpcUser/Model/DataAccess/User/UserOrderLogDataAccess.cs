...
namespace HPC.Projects.DataAccess
{
    ...
    /// 用户日志
    /// </summary>
    sealed partial class UserOrderLogDataAccess : SqlServerTable<UserOrderLogData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<UserOrderLogData, bool>> lambda)
        {

...
namespace HPC.Projects.DataAccess
{
    ...
    /// 用户车
    /// </summary>
    sealed partial class UserCartDataAccess : SqlServerTable<UserCartData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<UserCartData, bool>> lambda)
        {

...
namespace HPC.Projects.DataAccess
{
    ...
    /// 用户地址
    /// </summary>
    sealed partial class UserAddressDataAccess : SqlServerTable<UserAddressData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<UserAddressData, bool>> lambda)
        {

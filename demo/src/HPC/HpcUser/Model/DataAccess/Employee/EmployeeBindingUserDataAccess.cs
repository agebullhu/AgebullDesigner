...
namespace HPC.Projects.DataAccess
{
    ...
    /// 员工绑定用户
    /// </summary>
    sealed partial class EmployeeBindingUserDataAccess : SqlServerTable<EmployeeBindingUserData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<EmployeeBindingUserData, bool>> lambda)
        {

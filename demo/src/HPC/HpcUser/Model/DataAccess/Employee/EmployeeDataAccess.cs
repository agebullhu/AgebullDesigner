...
namespace HPC.Projects.DataAccess
{
    ...
    /// 员工
    /// </summary>
    sealed partial class EmployeeDataAccess : SqlServerTable<EmployeeData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<EmployeeData, bool>> lambda)
        {

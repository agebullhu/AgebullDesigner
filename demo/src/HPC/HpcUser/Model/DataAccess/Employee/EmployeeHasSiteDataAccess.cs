...
namespace HPC.Projects.DataAccess
{
    ...
    /// 员工站点关联
    /// </summary>
    sealed partial class EmployeeHasSiteDataAccess : SqlServerTable<EmployeeHasSiteData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<EmployeeHasSiteData, bool>> lambda)
        {

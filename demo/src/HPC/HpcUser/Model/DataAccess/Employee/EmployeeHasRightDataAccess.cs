...
namespace HPC.Projects.DataAccess
{
    ...
    /// 员工特权
    /// </summary>
    sealed partial class EmployeeHasRightDataAccess : SqlServerTable<EmployeeHasRightData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<EmployeeHasRightData, bool>> lambda)
        {

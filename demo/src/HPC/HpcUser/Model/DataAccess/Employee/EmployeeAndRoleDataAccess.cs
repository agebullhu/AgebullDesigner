...
namespace HPC.Projects.DataAccess
{
    ...
    /// 员工和角色
    /// </summary>
    sealed partial class EmployeeAndRoleDataAccess : SqlServerTable<EmployeeAndRoleData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<EmployeeAndRoleData, bool>> lambda)
        {

...
namespace HPC.Projects.DataAccess
{
    ...
    /// 组织SKU
    /// </summary>
    partial class ProductSkuInOrgDataAccess : SqlServerTable<ProductSkuInOrgData,HpcSqlServerDb>
    {
        /// <summary>
        /// 构造单个读取命令
        /// </summary>
        ...
        public SqlCommand CreateCommand(Expression<Func<ProductSkuInOrgData, bool>> lambda)
        {

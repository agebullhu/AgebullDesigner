...
namespace Agebull.EntityModel.Config
{
    ...
    public class FieldConfigV5 : ConfigBase, IFieldConfig
    {
        #region 环境
        ...
        {
            get => NoStorage ? AccessScopeType.Client : _denyScope;
            set
            {
                if (_denyScope == value)
                    return;
        ...
        {
            get => CustomType == null ? null : GetEnumConfig();
            set
            {
        ...
        public bool IsBlob
        {
            get => _isBlob || DataType == "ByteArray";
            set
            {

...
namespace Agebull.EntityModel.Config
{
    ...
    public partial class PropertyConfig : ConfigBase
    {
        ...
        public bool CanGet
        {
            get => !_canGet
                ? false
                : !IsCustomCompute || !string.IsNullOrWhiteSpace(ComputeGetCode);
            set => _canGet = value;
        }
        ...
        public bool CanSet
        {
            get => !_canGet
                ? false
                : !IsCustomCompute || !string.IsNullOrWhiteSpace(ComputeSetCode);
            set => _canGet = value;
        }
        /// <summary>
        /// 计算列的说明文字
        ...
        /// </remark>
        [IgnoreDataMember, JsonIgnore]
        [Category(@"用户界面"), DisplayName(@"字段名称(json)"), Description("json字段名称")]

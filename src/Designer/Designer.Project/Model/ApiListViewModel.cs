...
{
    public sealed class ApiListViewModel : EditorViewModelBase<ApiListModel>
    {
    }
    ...
    public sealed class ApiListModel : DesignModelBase
    {
        ...
        public bool SelectAll
        {
            ...
            set
            {
                ...
                Context.SelectProject?.ApiItems.Foreach(p => p.Option.IsSelect = value);
            }
        }
        ...
        internal bool OnCommandExec(CommandItemBase cmd)
        {
            if (Context.SelectProject == null)
                return true;
            foreach (var entity in Context.SelectProject.ApiItems)
            {

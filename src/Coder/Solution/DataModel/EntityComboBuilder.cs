...
{
    public sealed class EntityComboBuilder : CoderWithEntity
    {
        /// <summary>
        /// 名称
        /// </summary>
        protected override string Name => "File_Model_EntityCombo_cs";
        ...
        protected override void CreateExCode(string path)
        {
            ...
            string file = Path.Combine(path, Entity.Name + ".combo.cs");
            string code =
                $@"using System.Collections.Generic;
using System.Linq;
...
{{
    ...
    {{
        ...
        protected sealed override void OnDataSaved({Entity.EntityName} entity)
        {{
            using (var proxy = new RedisProxy(RedisProxy.DbComboCache))
            {{

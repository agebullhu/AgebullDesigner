...
namespace Agebull.EntityModel.RobotCoder.Funds
{
    ...
    public class UnitTestMomentCoder : MomentCoderBase, IAutoRegister
    {
        ...
        {
            MomentCoder.RegisteCoder("期货相关", "实体序列化单元测试(C++)", "cpp", EntityUt);
            MomentCoder.RegisteCoder("期货相关", "API请求测试(C++)", "cpp", ApiUt);
            MomentCoder.RegisteCoder("期货相关", "赋值代码(C++)", "cpp", CreateEntityCode);
        }
        #endregion
